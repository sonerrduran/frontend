...
const PentominoPuzzleGame: React.FC<PentominoPuzzleGameProps> = ({ onBack }) => {
  ...
  const pentominoes: { [key: number]: { shape: PentominoShape; color: string; name: string } } = {
    ...
    2: { shape: [[1,1],[1,0],[1,0],[1,0]], color: 'bg-blue-500', name: 'L' },
    3: { shape: [[1,1,1],[1,0,0],[1,0,0]], color: 'bg-green-500', name: 'V' },
    4: { shape: [[1,1,1],[0,1,0],[0,1,0]], color: 'bg-yellow-500', name: 'T' },
    5: { shape: [[0,1,1],[1,1,0],[1,0,0]], color: 'bg-purple-500', name: 'Z' },
    6: { shape: [[1,1,0],[0,1,1],[0,1,0]], color: 'bg-pink-500', name: 'W' },
    7: { shape: [[1,1,1],[1,1,0]], color: 'bg-orange-500', name: 'P' },
    8: { shape: [[1,1,1],[1,0,1]], color: 'bg-cyan-500', name: 'U' },
    9: { shape: [[0,1,0],[1,1,1],[0,1,0]], color: 'bg-indigo-500', name: 'X' },
    10: { shape: [[1,0,0],[1,1,1],[0,0,1]], color: 'bg-teal-500', name: 'N' },
    11: { shape: [[1,1],[1,1],[1,0]], color: 'bg-lime-500', name: 'F' },
    12: { shape: [[0,1,0],[1,1,1],[1,0,0]], color: 'bg-amber-500', name: 'Y' }
  };
  ...
  const initializeBoard = () => {
    // 10x6 board
    const newBoard = Array(6).fill(0).map(() => Array(10).fill(0));
    setBoard(newBoard);
