      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            ...
            <div className="px-6 py-3 bg-slate-800/80 rounded-xl">
              <span className={`font-black ${screenTime > 120 ? 'text-red-400' : 'text-green-400'}`}>
        ...
        <div className="text-center mb-8">
          <h1 className="text-white text-4xl md:text-5xl font-black mb-4">⏰ Ekran Süresi Yönetimi</h1>
                ...
                {activityOptions.map((activity, index) => (
                  <button
                    ...
                    className={`bg-gradient-to-br ${
                      activity.isScreen ? 'from-purple-500/20 to-pink-500/20' : 'from-green-500/20 to-emerald-500/20'
        ...
        {message && (
          <div className={`fixed bottom-8 left-1/2 transform -translate-x-1/2 text-xl font-black p-4 rounded-xl ${
            message.includes('✅') || message.includes('🎉') ? 'bg-green-500/90 text-white' : 
            message.includes('⚠️') || message.includes('❌') ? 'bg-red-500/90 text-white' : 'bg-blue-500/90 text-white'
          }`}>
            {message}
          </div>
        )}
