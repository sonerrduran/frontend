        ...
        <div className="w-full max-w-2xl mx-auto bg-slate-900/90 backdrop-blur-3xl rounded-[40px] p-6 md:p-8 border border-red-500/30 shadow-2xl relative overflow-hidden bounce-in">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-center flex-1">
                    <h2 className="text-2xl md:text-3xl font-black italic text-red-500 drop-shadow-lg uppercase tracking-tight">XV Sudoku</h2>
                ...
                >
                    ...
                    {board.map((row, r) =>
                        row.map((cell, c) => {
                            ...
                            const boxRows = size === 4 ? 2 : 2;
                            const boxCols = size === 4 ? 2 : 3;
                            const borderRight = (c + 1) % boxCols === 0 && c !== size - 1 ? 'border-r-4 border-red-800' : 'border-r border-slate-700/50';
                            const borderBottom = (r + 1) % boxRows === 0 && r !== size - 1 ? 'border-b-4 border-red-800' : 'border-b border-slate-700/50';
