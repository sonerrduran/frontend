...
const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ 
  ...
  return (
    <div className={containerClasses}>
      <div className={`${sizeClasses[size]} border-purple-200 border-t-purple-500 rounded-full animate-spin`} />
      {message && (
        <p className="text-white text-xl mt-6 animate-pulse">{message}</p>
      )}
