    ...
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-pink-500 to-purple-600 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-red-600 mb-8 text-center">Pozitif-Negatif Savaşı ⚔️</h3>
          ...
          {showFeedback && (
            <div className={`mt-6 p-4 rounded-2xl text-center font-bold text-xl ${selectedAnswer === correctAnswer ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
              {selectedAnswer === correctAnswer ? '🎉 Harika!' : `❌ Yanlış! Doğru: ${correctAnswer}`}
            </div>
          )}
        </div>
      </div>
