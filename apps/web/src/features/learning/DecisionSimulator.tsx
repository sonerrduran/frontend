...
const SCENARIOS = [
    {
        ...
        description: "İstasyonun enerji sistemlerinde bir arıza var ve yedek güç sadece bir bölümü besleyebilir. Ne yaparsın?",
        options: [
            { text: "Yaşam destek ünitesine güç ver (Güvenli Yol)", result: "Herkes güvende ancak görev verileri kayboldu.", score: 50 },
            { text: "Laboratuvar verilerini koru (Riskli Yol)", result: "Veriler kurtarıldı ama oksijen seviyesi kritik seviyeye indi!", score: 30 },
            { text: "Tüm sistemleri %20 kapasiteyle çalıştır (Dengeli)", result: "Sistemler stabil kaldı, harika bir kriz yönetimi!", score: 100 }
        ]
    }
];
        ...
        <div className="flex flex-col items-center justify-center min-h-[500px] p-4 text-white">
            <div className="w-full max-w-3xl bg-slate-900/80 backdrop-blur-3xl rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl relative overflow-hidden">
                <div className="text-center mb-10">
                    <h3 className="font-black tracking-widest text-xs uppercase mb-2 opacity-40">STRATEJİ VE KARAR VERME</h3>
                    <h2 className="text-3xl font-black uppercase italic tracking-tighter">Karar Simülatörü</h2>
                </div>
                ...
                {selection !== null && (
                    <div className="mt-10 p-8 bg-black/40 rounded-[32px] border border-cyan-500/30 animate-in zoom-in duration-500 text-center">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest opacity-40 mb-8">Puan: {scenario.options[selection].score}</p>
                        <button
