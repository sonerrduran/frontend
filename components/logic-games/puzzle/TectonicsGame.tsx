...
const TectonicsGame: React.FC<TectonicsGameProps> = ({ onBack }) => {
  ...
  const getRegionColor = (regionId: number) => {
    const colors = [
      'bg-red-200/40', 'bg-blue-200/40', 'bg-green-200/40', 'bg-yellow-200/40',
      'bg-purple-200/40', 'bg-pink-200/40', 'bg-indigo-200/40', 'bg-orange-200/40',
      'bg-teal-200/40', 'bg-cyan-200/40', 'bg-lime-200/40', 'bg-amber-200/40',
      'bg-rose-200/40'
    ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 mb-4">
          ...
          <div className="flex justify-center gap-2 flex-wrap">
            ...
            <button
              onClick={() => selectedCell && setGrid(grid.map((r, ri) => r.map((c, ci) => ri === selectedCell[0] && ci === selectedCell[1] ? null : c)))}
              disabled={!selectedCell}
