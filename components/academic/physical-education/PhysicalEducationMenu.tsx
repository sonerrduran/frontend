...
import { getSubjectById } from '../../../src/config/subjects';

const PhysicalEducationMenu: React.FC = () => {
  const navigate = useNavigate();
  const subject = getSubjectById('physical-education');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {subject.grades.map((grade) => (
            <button key={grade} onClick={() => navigate(`/academic/physical-education/grade${grade}`)}
