        ...
        return (
            <div className="min-h-screen text-white p-4 flex items-center justify-center">
                <div className="bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-white/20 max-w-2xl w-full text-center">
                    ...
                    <div className="text-6xl font-black text-yellow-400 mb-4">{score} / {QUESTIONS.length * 10}</div>
                    <p className="text-2xl mb-8">Başarı: %{percentage.toFixed(0)}</p>
                    <div className="flex gap-4 justify-center">
                        <button onClick={handleRestart} className="bg-gradient-to-r from-indigo-500 to-purple-600 px-8 py-4 rounded-xl font-black hover:scale-105 transition-all">
                            🔄 TEKRAR DENE
                        </button>
            ...
            <div className="w-full max-w-4xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm text-white/60">Soru {currentQuestion + 1} / {QUESTIONS.length}</p>
                    </div>
