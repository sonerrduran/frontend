...
import FruitAdditionGame from './components/academic/math/grade1/basic/FruitAdditionGame';
import FishAdditionGame from './components/academic/math/grade1/basic/FishAdditionGame';
import SpaceAdditionGame from './components/academic/math/grade1/basic/SpaceAdditionGame';
import AdditionPuzzleGame from './components/academic/math/grade1/basic/AdditionPuzzleGame';
import AdditionRaceGame from './components/academic/math/grade1/basic/AdditionRaceGame';
import CookieMonsterGame from './components/academic/math/grade1/basic/CookieMonsterGame';
import BalloonPopGame from './components/academic/math/grade1/basic/BalloonPopGame';
import ToyLostGame from './components/academic/math/grade1/basic/ToyLostGame';
import SubtractionBasketGame from './components/academic/math/grade1/basic/SubtractionBasketGame';
import AlienSubtractionGame from './components/academic/math/grade1/basic/AlienSubtractionGame';
import MultiplicationNinjaGame from './components/academic/math/grade1/basic/MultiplicationNinjaGame';
import DivisionHuntGame from './components/academic/math/grade1/basic/DivisionHuntGame';
import MathBasketballGame from './components/academic/math/grade1/basic/MathBasketballGame';
import ProblemSolvingGame from './components/academic/math/grade1/basic/ProblemSolvingGame';
import ShapeHuntGame from './components/academic/math/grade1/geometry/ShapeHuntGame';
import ShapePuzzleGame from './components/academic/math/grade1/geometry/ShapePuzzleGame';
import ShapePaintingGame from './components/academic/math/grade1/geometry/ShapePaintingGame';
import ShapeBuilderGame from './components/academic/math/grade1/geometry/ShapeBuilderGame';
import ShadowMatchGame from './components/academic/math/grade1/geometry/ShadowMatchGame';
import GeometryShapeMatchingGame from './components/academic/math/grade1/geometry/ShapeMatchingGame';
import LeftRightRaceGame from './components/academic/math/grade1/geometry/LeftRightRaceGame';
import GeometricShapeRecognitionGame from './components/academic/math/grade1/geometry/GeometricShapeRecognitionGame';
import AreaCalculationGame from './components/academic/math/grade1/geometry/AreaCalculationGame';
import PerimeterCalculationGame from './components/academic/math/grade1/geometry/PerimeterCalculationGame';
import LocationPuzzleGame from './components/academic/math/grade1/geometry/LocationPuzzleGame';
import InsideOutsideGame from './components/academic/math/grade1/geometry/InsideOutsideGame';
import ShapeDetectiveGame from './components/academic/math/grade1/geometry/ShapeDetectiveGame';
import VacationRouteGame from './components/academic/math/grade1/geometry/VacationRouteGame';
import MissingShapeGame from './components/academic/math/grade1/geometry/MissingShapeGame';
import ShapeLabyrinthGame from './components/academic/math/grade1/geometry/ShapeLabyrinthGame';
import BalloonCountGame from './components/academic/math/grade1/numbers/BalloonCountGame';
import NumberTrainGame from './components/academic/math/grade1/numbers/NumberTrainGame';
import NumberBuildingGame from './components/academic/math/grade1/numbers/NumberBuildingGame';
import AppleCollectGame from './components/academic/math/grade1/numbers/AppleCollectGame';
import BoomGame from './components/academic/math/grade1/rhythmic/BoomGame';
import CountdownGame from './components/academic/math/grade1/rhythmic/CountdownGame';
import SkipCountingGame from './components/academic/math/grade1/rhythmic/SkipCountingGame';
import RhythmicRunGame from './components/academic/math/grade1/rhythmic/RhythmicRunGame';
import BigSmallRaceGame from './components/academic/math/grade1/comparison/BigSmallRaceGame';
import NumberLineGame from './components/academic/math/grade1/comparison/NumberLineGame';
import SizeOrderGame from './components/academic/math/grade1/comparison/SizeOrderGame';
import MostFruitGame from './components/academic/math/grade1/comparison/MostFruitGame';
import ToyGraphGame from './components/academic/math/grade1/comparison/ToyGraphGame';
import AnimalCountGame from './components/academic/math/grade1/comparison/AnimalCountGame';
import FavoriteColorSurveyGame from './components/academic/math/grade1/comparison/FavoriteColorSurveyGame';
import GraphCompletionGame from './components/academic/math/grade1/comparison/GraphCompletionGame';
import RaceOrderGame from './components/academic/math/grade1/comparison/RaceOrderGame';
import CorrectOrderGame from './components/academic/math/grade1/comparison/CorrectOrderGame';
import ElectionTallyGame from './components/academic/math/grade1/comparison/ElectionTallyGame';
import IceCreamGraphGame from './components/academic/math/grade1/comparison/IceCreamGraphGame';
import WhoBiggerGame from './components/academic/math/grade1/comparison/WhoBiggerGame';
import LongestLineGame from './components/academic/math/grade1/comparison/LongestLineGame';
import GraphReadingGame from './components/academic/math/grade1/comparison/GraphReadingGame';
import LengthCompareGame from './components/academic/math/grade1/measurement/LengthCompareGame';
import MoneyCountGame from './components/academic/math/grade1/measurement/MoneyCountGame';
import WeightCompareGame from './components/academic/math/grade1/measurement/WeightCompareGame';
import LongestObjectGame from './components/academic/math/grade1/measurement/LongestObjectGame';
import HeaviestObjectGame from './components/academic/math/grade1/measurement/HeaviestObjectGame';
import ClockReadingGame from './components/academic/math/grade1/measurement/ClockReadingGame';
import EstimateJarGame from './components/academic/math/grade1/measurement/EstimateJarGame';
import MemoryMatchGame from './components/academic/math/grade1/visual/MemoryMatchGame';
import MemoryCardsGame from './components/academic/math/grade1/visual/MemoryCardsGame';
import ColorDetectiveGame from './components/academic/math/grade1/visual/ColorDetectiveGame';
import ShapeHunterGame from './components/academic/math/grade1/visual/ShapeHunterGame';
import SizeMatchGame from './components/academic/math/grade1/visual/SizeMatchGame';
import DirectionMatchGame from './components/academic/math/grade1/visual/DirectionMatchGame';
import CarefulEyesGame from './components/academic/math/grade1/visual/CarefulEyesGame';
import FindDifferenceGame from './components/academic/math/grade1/visual/FindDifferenceGame';
import PatternContinueGame from './components/academic/math/grade1/visual/PatternContinueGame';
import PlaygroundMemoryGame from './components/math/playground/MemoryMatchGame';
import NumberHuntTo100Game from './components/academic/math/grade2/numbers/NumberHuntTo100Game';
import PlaceValueGame from './components/academic/math/grade2/numbers/PlaceValueGame';
import NumberLineJumpGame from './components/academic/math/grade2/numbers/NumberLineJumpGame';
import MarketBasketGame from './components/academic/math/grade2/addition/MarketBasketGame';
import TwoDigitAdditionGame from './components/academic/math/grade2/addition/TwoDigitAdditionGame';
import MissingNumberGame from './components/academic/math/grade2/addition/MissingNumberGame';
import ChangeCalculatorGame from './components/academic/math/grade2/subtraction/ChangeCalculatorGame';
import TwoDigitSubtractionGame from './components/academic/math/grade2/subtraction/TwoDigitSubtractionGame';
import CompareSubtractionGame from './components/academic/math/grade2/subtraction/CompareSubtractionGame';
import ShapeCountGame from './components/academic/math/grade2/geometry/ShapeCountGame';
import SymmetryGame from './components/academic/math/grade2/geometry/SymmetryGame';
import SimpleGraphGame from './components/academic/math/grade2/data/SimpleGraphGame';
import MultiplicationBattleGame from './components/academic/math/grade3/multiplication/MultiplicationBattleGame';
import MultiplicationTableGame from './components/academic/math/grade3/multiplication/MultiplicationTableGame';
import PizzaSharingGame from './components/academic/math/grade3/division/PizzaSharingGame';
import DivisionRaceGame from './components/academic/math/grade3/division/DivisionRaceGame';
import ThousandHuntGame from './components/academic/math/grade4/bignumbers/ThousandHuntGame';
import NumberCompareGame from './components/academic/math/grade4/bignumbers/NumberCompareGame';
import FractionCompareGame from './components/academic/math/grade5/fractions/FractionCompareGame';
import FractionAdditionGame from './components/academic/math/grade5/fractions/FractionAdditionGame';
import DecimalMarketGame from './components/academic/math/grade6/decimals/DecimalMarketGame';
import DecimalSortGame from './components/academic/math/grade6/decimals/DecimalSortGame';
import TemperatureGame from './components/academic/math/grade7/integers/TemperatureGame';
import IntegerBattleGame from './components/academic/math/grade7/integers/IntegerBattleGame';
import ExponentRaceGame from './components/academic/math/grade8/exponents/ExponentRaceGame';
import ExponentPuzzleGame from './components/academic/math/grade8/exponents/ExponentPuzzleGame';
import VowelConsonantGame from './components/academic/turkish/grade1/letters/VowelConsonantGame';
import LetterMatchGame from './components/academic/turkish/grade1/letters/LetterMatchGame';
import SyllableCountGame from './components/academic/turkish/grade1/words/SyllableCountGame';
import WordMakingGame from './components/academic/turkish/grade1/reading/WordMakingGame';
import StoryComprehensionGame from './components/academic/turkish/grade1/reading/StoryComprehensionGame';
