...
const BlockedSudokuGame: React.FC<BlockedSudokuGameProps> = ({ onBack }) => {
  ...
  const generatePuzzle = () => {
    ...
    const newBlockedCells: boolean[][] = Array(9).fill(0).map(() => Array(9).fill(false));
      ...
      <div className="max-w-4xl mx-auto">
        {showLevelSelect ? (
          ...
          <div className="text-center">
            <button onClick={onBack} className="mb-6 px-6 py-3 bg-white/10 hover:bg-white/20 rounded-xl text-white font-bold transition-all">
              ⬅ GERİ DÖN
            </button>
          ...
          <>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <h1 className="text-3xl md:text-4xl font-black text-white">Bloklu Sudoku - Seviye {level}</h1>
                    ...
                    {row.map((cell, j) => (
                      <button
                        ...
                        className={`w-10 h-10 md:w-12 md:h-12 border font-bold text-lg md:text-xl transition-all ${
                          ...
                          j % 3 === 2 && j < 8 ? 'border-r-4 border-r-gray-800' : 'border-r-gray-400'
                        } ${
                          i % 3 === 2 && i < 8 ? 'border-b-4 border-b-gray-800' : 'border-b-gray-400'
                        }`}
                      >
