...
const PROVERBS = [
    { proverb: "Damlaya damlaya göl olur", meaning: "Küçük birikimler zamanla büyük sonuçlar verir", lesson: "Sabır ve azim" },
    { proverb: "Sakla samanı gelir zamanı", meaning: "Her şey bir gün işe yarayabilir", lesson: "Tasarruf" },
    { proverb: "Ne ekersen onu biçersin", meaning: "Yaptığın işin sonucunu görürsün", lesson: "Sorumluluk" },
    { proverb: "Acele işe şeytan karışır", meaning: "Aceleyle yapılan işler hatalı olur", lesson: "Sabır" },
    { proverb: "Ağaç yaşken eğilir", meaning: "Eğitim küçük yaşta başlamalı", lesson: "Eğitim" },
    { proverb: "Dost kara günde belli olur", meaning: "Gerçek dostlar zor zamanlarda ortaya çıkar", lesson: "Dostluk" },
    { proverb: "El elin eşeğini türkü çağırarak arar", meaning: "Herkes kendi işini över", lesson: "Öz eleştiri" },
    { proverb: "Güneş balçıkla sıvanmaz", meaning: "Gerçek gizlenemez", lesson: "Dürüstlük" },
    { proverb: "İşleyen demir pas tutmaz", meaning: "Çalışan insan başarılı olur", lesson: "Çalışkanlık" },
    { proverb: "Yalancının mumu yatsıya kadar yanar", meaning: "Yalan er geç ortaya çıkar", lesson: "Doğruluk" }
];
