        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-700 p-8">
          ...
          <div className="bg-gradient-to-br from-cyan-500 via-teal-500 to-cyan-600 rounded-2xl p-8 md:p-12 mb-8">
            ...
            <div className="bg-cyan-700/40 rounded-2xl p-8 mb-8 border-2 border-cyan-300">
              <p className="text-white text-2xl font-bold text-center mb-6">Bu dikdörtgenin alanı kaç birim karedir?</p>
              <div className="flex justify-center items-center">
                ...
                >
                  {Array.from({ length: width * height }).map((_, idx) => (
                    <div key={idx} className="w-14 h-14 bg-cyan-300/80 border-2 border-cyan-500 rounded-lg" />
                  ))}
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl flex flex-col items-center justify-center z-50 p-6 text-center">
          <div className="bg-slate-800/90 p-6 md:p-8 rounded-3xl border border-cyan-500/30 max-w-md w-full">
            ...
            <ul className="text-white/90 text-left space-y-3 mb-8 text-sm md:text-base">
              <li className="flex gap-2"><span className="text-cyan-400 font-bold">1.</span> Ekranda bir ızgara göreceksin</li>
              <li className="flex gap-2"><span className="text-cyan-400 font-bold">2.</span> Kareleri sayarak alanı hesapla</li>
              <li className="flex gap-2"><span className="text-cyan-400 font-bold">3.</span> Genişlik × Yükseklik = Alan</li>
              <li className="flex gap-2"><span className="text-cyan-400 font-bold">4.</span> Doğru cevabı seç ve puan kazan!</li>
            </ul>
            <button
