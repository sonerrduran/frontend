...
export default function CyberbullyGame({ onExit }: CyberbullyGameProps) {
  ...
  const handleAnswer = (isBullying: boolean) => {
    if (isBullying === currentMessage.isBullying) {
      ...
      setFeedback(`❌ Yanlış! Bu mesaj ${currentMessage.isBullying ? 'siber zorbalıktır' : 'normal bir mesajdır'}.`);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-white text-4xl md:text-5xl font-black mb-4">🚫 Siber Zorbalığı Durdur</h1>
        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-red-500/30 p-8">
          ...
          {feedback && (
            <div className={`text-center text-lg font-black p-4 rounded-xl ${
