    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-600 via-rose-500 to-red-500 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-pink-600 mb-8 text-center">Sesli mi Sessiz mi? 🎵</h3>
          ...
          <div className="grid grid-cols-2 gap-6">
            <button
              ...
              className={`p-8 rounded-2xl font-black text-3xl transition-all ${
                showFeedback
                  ? correctAnswer === 'sesli' ? 'bg-green-500 text-white scale-105' : selectedAnswer === 'sesli' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-400'
            ...
            <button
              ...
              className={`p-8 rounded-2xl font-black text-3xl transition-all ${
                showFeedback
                  ? correctAnswer === 'sessiz' ? 'bg-green-500 text-white scale-105' : selectedAnswer === 'sessiz' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-400'
          ...
          {showFeedback && (
            <div className={`mt-6 p-4 rounded-2xl text-center font-bold text-xl ${selectedAnswer === correctAnswer ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
              {selectedAnswer === correctAnswer ? '🎉 Doğru! Aferin!' : `❌ Yanlış! ${currentLetter} ${correctAnswer} harftir.`}
            </div>
          )}
        </div>
      </div>
