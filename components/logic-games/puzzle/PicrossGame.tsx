...
const PicrossGame: React.FC<PicrossGameProps> = ({ onBack }) => {
  ...
  const generatePuzzle = () => {
    ...
    const newGrid: (boolean | null)[][] = Array(size).fill(null).map(() => Array(size).fill(null));
          ...
          <div className="flex">
            ...
            <div className="flex flex-col">
              ...
              {colClues.map((clues, idx) => (
                <div key={idx} className="flex flex-col items-center justify-end" style={{ width: '40px', height: '40px' }}>
