          ...
          <div className="bg-gradient-to-br from-pink-500 via-rose-500 to-pink-600 rounded-2xl p-8 md:p-12 mb-8">
            ...
            {feedback && (
              <div className={`mt-8 text-center text-2xl font-black p-6 rounded-xl ${
                feedback.includes('Mükemmel') ? 'bg-green-500/90 border-2 border-green-300 text-white' : 'bg-red-500/90 border-2 border-red-300 text-white'
              }`}>
                {feedback}
              </div>
            )}
        ...
        <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl flex flex-col items-center justify-center z-50 p-6 text-center">
          <div className="bg-slate-800/90 p-6 md:p-8 rounded-3xl border border-pink-500/30 max-w-md w-full">
            ...
            <ul className="text-white/90 text-left space-y-3 mb-8 text-sm md:text-base">
              <li className="flex gap-2"><span className="text-pink-400 font-bold">1.</span> Yukarıda gösterilen şekli ve rengi bul</li>
              <li className="flex gap-2"><span className="text-pink-400 font-bold">2.</span> Doğru şekil ve renk kombinasyonunu seç</li>
              <li className="flex gap-2"><span className="text-pink-400 font-bold">3.</span> Her doğru cevap puan kazandırır!</li>
              <li className="flex gap-2"><span className="text-pink-400 font-bold">4.</span> 5 seviyeyi tamamla ve kazanan sen ol!</li>
            </ul>
            <button
