...
const EnglishGrade2Menu: React.FC = () => {
  ...
  const topics = [
    { 
      ...
      games: [
        { path: '/english/grade2/vocabulary/color-match', name: 'Renk Eşleştirme' },
      ]
    },
    { 
      id: 'grammar', 
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-orange-700 to-orange-500 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
            ...
            <div key={topic.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                {topic.games.map((game, idx) => (
                  <button key={idx} onClick={() => game.path !== '#' && navigate(game.path)}
        ...
        <div className="mt-8 text-center">
          <button onClick={() => navigate('/academic/english')}
