            ...
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-white/20 max-w-md w-full text-center">
                    ...
                    <div className="space-y-3 mb-6">
                        <p className="text-white/90 text-lg">Puan: <span className="font-black text-yellow-400">{score}</span></p>
                        <p className="text-white/90 text-lg">Doğruluk: <span className="font-black text-green-400">{accuracy}%</span></p>
                        ...
                        {WORD_CATEGORIES.map((category, index) => (
                            ...
                            >
                                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform">
                                    {category.type === 'synonym-match' ? '🔄' : category.type === 'antonym-match' ? '⚖️' : '💬'}
                                </div>
