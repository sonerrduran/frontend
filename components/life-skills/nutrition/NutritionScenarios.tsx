  ...
  1: [
    {
      ...
      icon: '🥣',
      scenario: 'Sabah okula gitmeden önce kahvaltı yapacaksın. Masada süt, meyve, ekmek ve çikolata var.',
      question: 'Sağlıklı bir kahvaltı için ne seçmelisin?',
      options: [
        { text: 'Sadece çikolata yemeliyim', isCorrect: false, feedback: 'Çikolata tek başına sağlıklı bir kahvaltı değil.' },
        { text: 'Süt, meyve ve ekmek yemeliyim', isCorrect: true, feedback: 'Doğru! Dengeli bir kahvaltı enerji verir.' },
  ...
  2: [
    {
      ...
      icon: '🏫',
      scenario: 'Teneffüste kantinden bir şeyler almak istiyorsun. Cips, meyve suyu, süt ve meyve var.',
      question: 'En sağlıklı seçim hangisi?',
      options: [
        { text: 'Cips almalıyım', isCorrect: false, feedback: 'Cips sağlıksız bir atıştırmalık.' },
        { text: 'Meyve ve süt almalıyım', isCorrect: true, feedback: 'Doğru! Meyve ve süt sağlıklı seçimler.' },
        { text: 'Sadece meyve suyu almalıyım', isCorrect: false, feedback: 'Taze meyve daha sağlıklı.' }
      ]
    }
  ],
  3: [
    {
      ...
      options: [
        ...
        { text: 'Sebze yemeğini yemeli, bazen hamburger yiyebilirim', isCorrect: true, feedback: 'Doğru! Dengeli beslenme önemli.' },
        { text: 'Her gün hamburger yemeliyim', isCorrect: false, feedback: 'Fast food her gün yenmemeli.' }
      ]
    }
  ],
  4: [
    {
      ...
      options: [
        { text: 'Ağır bir yemek yemeliyim', isCorrect: false, feedback: 'Ağır yemek spor performansını düşürür.' },
        { text: 'Muz veya hafif sandviç yemeliyim', isCorrect: true, feedback: 'Doğru! Hafif karbonhidrat enerji verir.' },
        { text: 'Hiçbir şey yememeliyim', isCorrect: false, feedback: 'Spor öncesi enerji gerekir.' }
      ]
    }
  ],
  5: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Gazlı içecek içmeliyim', isCorrect: false, feedback: 'Gazlı içecekler su yerine geçmez.' },
        { text: 'Düzenli su içme alışkanlığı edinmeliyim', isCorrect: true, feedback: 'Doğru! Günde 6-8 bardak su içmek önemli.' },
        { text: 'Sadece aç olunca su içmeliyim', isCorrect: false, feedback: 'Düzenli su içmek gerekir.' }
      ]
    }
  ],
  6: [
    {
      ...
      options: [
        ...
        { text: 'Dengeli beslenip düzenli egzersiz yapmalıyım', isCorrect: true, feedback: 'Doğru! Sağlıklı kilo kontrolü dengeli beslenme ve egzersizle olur.' },
  ...
  7: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Ben de içmeliyim', isCorrect: false, feedback: 'Enerji içecekleri sağlıksız ve zararlı.' },
        { text: 'Yeterli uyku, dengeli beslenme ve su içmeliyim', isCorrect: true, feedback: 'Doğru! Doğal yollarla enerji sağlamak daha sağlıklı.' },
  ...
  8: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen başlamalıyım', isCorrect: false, feedback: 'Plansız başlamak eksikliklere neden olur.' },
        { text: 'Araştırma yapmalı, diyetisyene danışmalı ve dengeli plan yapmalıyım', isCorrect: true, feedback: 'Doğru! Bilinçli ve planlı geçiş önemli.' },
        { text: 'Sadece sebze yemeliyim', isCorrect: false, feedback: 'Protein kaynakları da gerekli.' }
      ]
    }
  ]
};
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <div className="bg-green-500/20 px-4 py-2 rounded-full border border-green-500/30">
              <span className="text-green-300 font-bold">Tamamlanan: {completedScenarios.length}/{allScenarios.length}</span>
            </div>
          </div>
        </div>
