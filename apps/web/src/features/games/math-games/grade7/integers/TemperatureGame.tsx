    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-cyan-800 to-teal-700 p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white drop-shadow-lg">🌡️ Sıcaklık Oyunu</h1>
          ...
          <>
            <div className="bg-white/30 backdrop-blur-md rounded-3xl p-8 mb-8 shadow-2xl">
              ...
              <div className="grid grid-cols-3 gap-6 items-center mb-6">
                <div className={`bg-gradient-to-br ${getTempColor(startTemp)} rounded-3xl p-8 text-center shadow-2xl`}>
                ...
                <div className="text-center">
                  <div className={`text-6xl font-black ${change >= 0 ? 'text-red-400' : 'text-blue-400'}`}>
                    {change >= 0 ? '+' : ''}{change}°C
                  </div>
