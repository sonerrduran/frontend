...
const PROMPTS = [
    { title: "Kayıp Galaksi", start: "Uzay gemimiz hiç bilmediğimiz mor renkli bir gezegene iniş yaptı. Kapağı açtığımda karşımda duran şey..." },
    { title: "Zaman Gezgini", start: "Cebimdeki eski saatin kapağını çevirdiğimde aniden kendimi 100 yıl gelecekte buldum. İlk gördüğüm bina..." },
    { title: "Gizemli Ada", start: "Denizin ortasında haritada görünmeyen bir ada keşfettik. Kıyıda bizi bekleyen devasa ayak izleri..." }
];
        ...
        <div className="flex flex-col items-center justify-center min-h-[500px] p-4 text-white">
            <div className="w-full max-w-4xl bg-slate-900/80 backdrop-blur-3xl rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl">
                ...
                <div className="text-center mb-10">
                    <h3 className="font-black tracking-widest text-xs uppercase mb-2 opacity-40">YARATICI YAZARLIK</h3>
                    <h2 className="text-3xl font-black mb-2 uppercase italic">Hikaye Tamamlama</h2>
                    <p className="text-white/60 text-sm">Verilen başlangıç cümlesinden yola çıkarak kendi maceranı oluştur.</p>
                </div>

                {!showPreview ? (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="bg-white/5 p-8 rounded-[32px] border border-white/10 relative">
                            <label className="absolute -top-3 left-6 bg-slate-900 px-3 text-[10px] font-black tracking-widest uppercase text-cyan-400">Başlangıç</label>
                        ...
                        <div className="relative">
                            <label className="absolute -top-3 left-6 bg-slate-900 px-3 text-[10px] font-black tracking-widest uppercase text-yellow-400">Senin Devamın</label>
                            <textarea
                    ...
                    <div className="animate-in zoom-in duration-500 text-center">
                        ...
                        <h3 className="text-2xl font-black mb-10 uppercase text-cyan-400">{PROMPTS[index].title}</h3>
