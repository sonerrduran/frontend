...
const DominoSudokuGame: React.FC<DominoSudokuGameProps> = ({ onBack }) => {
  ...
  const generatePuzzle = () => {
    ...
    const newSolution: number[][] = Array(8).fill(0).map(() => Array(8).fill(0));
    ...
    const used = Array(8).fill(0).map(() => Array(8).fill(false));
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 mb-8">
            ...
            <p className="text-white/80 text-center mb-6">
              Domino bölgelerinde Sudoku çöz!
            </p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-black text-white">Domino Sudoku</h1>
            <p className="text-blue-200">Seviye {currentLevel} - {levels[currentLevel - 1].name}</p>
          </div>
          <div className="w-24"></div>
        </div>
              ...
              <div key={i} className="flex">
                {row.map((cell, j) => (
                  <button
                    ...
                    className={`w-12 h-12 md:w-14 md:h-14 font-bold text-lg md:text-xl transition-all ${
                      getDominoBorder(i, j)
                    } ${
                      initialGrid[i][j] !== 0
