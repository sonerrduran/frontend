...
export default function NeedWantGame({ onExit }: NeedWantGameProps) {
  ...
  const handleAnswer = (isNeed: boolean) => {
    if (isNeed === currentItem.isNeed) {
      ...
      setFeedback(`❌ Yanlış! ${currentItem.name} bir ${currentItem.isNeed ? 'ihtiyaç' : 'istek'}tir.`);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-white text-4xl md:text-5xl font-black mb-4">🎯 İhtiyaç-İstek Ayırma</h1>
        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-blue-500/30 p-8">
          ...
          {feedback && (
            <div className={`text-center text-xl font-black p-4 rounded-xl ${
