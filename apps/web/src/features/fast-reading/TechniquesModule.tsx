    ...
    const techniques = [
        {
            ...
            action: 'Nasıl Yenilir? Okurken sakız çiğnemek, müzik dinlemek veya içinizden 1-2-3-4 diye ritim saymak beynin kelimeleri seslendirmesini engeller. Sadece gözlerinizle görmeye odaklanın.'
        },
        {
            ...
            action: 'Nasıl Yenilir? Okuduğunuz satırın üzerini (veya bilgisayar ekranında farenizle) bir kartla veya metin imleciyle kapatarak ilerleyin. Satır Takibi egzersizi bu yeteneği geliştirir.'
        },
        {
            ...
            action: 'Nasıl Yenilir? Kelime Gruplama egzersizimiz tam olarak bunun içindir. Gözleriniz kelimelerin ortasına odaklanıp etraftakileri algılamaya alıştıkça okuma hızınız katlanacaktır.'
        }
    ];
                ...
                <div className="flex flex-col gap-3 md:w-1/3 border-b md:border-b-0 md:border-r border-white/10 pb-6 md:pb-0 md:pr-6">
                    {techniques.map((tech, idx) => (
                        <button
                            ...
                            className={`text-left px-6 py-4 rounded-2xl font-bold transition-all flex items-center gap-3 ${activeTab === idx
