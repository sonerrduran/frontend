    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-600 via-rose-500 to-red-500 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <button onClick={onBack} className="px-6 py-3 bg-white/20 backdrop-blur-md text-white rounded-xl font-bold hover:bg-white/30 transition-all">
            ← Geri
          </button>
        ...
        <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 mb-6">
          <div className="flex justify-between items-center mb-2">
            <span className="text-white font-bold">Soru {round}/{patterns.length}</span>
          </div>
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-pink-600 mb-4 text-center">
            Simetri Var mı? 🪞
          </h3>
            ...
            <div className="flex justify-center items-center gap-6">
              {currentPattern.pattern.map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  {index === 1 && (
                    <div className="w-1 h-32 bg-purple-600 rounded-full"></div>
                  )}
                </React.Fragment>
              ))}
            </div>
          ...
          {showFeedback && (
            <div className={`mt-6 p-4 rounded-2xl text-center font-bold text-xl ${
              selectedAnswer === currentPattern.symmetric ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
            }`}>
