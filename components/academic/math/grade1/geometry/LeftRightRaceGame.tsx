        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-700 p-8">
          ...
          <div className="bg-gradient-to-br from-orange-500 via-amber-500 to-orange-600 rounded-2xl p-8 md:p-12 mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className={`px-6 py-3 rounded-xl font-black text-2xl ${
                timeLeft <= 1 ? 'bg-red-500/90 text-white animate-pulse' : 'bg-orange-700/40 border-2 border-orange-300 text-white'
              }`}>
                ⏱️ {timeLeft}s
              </div>
            </div>
        ...
        <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl flex flex-col items-center justify-center z-50 p-6 text-center">
          <div className="bg-slate-800/90 p-6 md:p-8 rounded-3xl border border-orange-500/30 max-w-md w-full">
            ...
            <ul className="text-white/90 text-left space-y-3 mb-8 text-sm md:text-base">
              <li className="flex gap-2"><span className="text-orange-400 font-bold">1.</span> Ekranda bir yön gösterilecek (Sol veya Sağ)</li>
              <li className="flex gap-2"><span className="text-orange-400 font-bold">2.</span> Hızlıca doğru yön butonuna tıkla</li>
              <li className="flex gap-2"><span className="text-orange-400 font-bold">3.</span> Hızlı cevap verirsen daha fazla puan kazanırsın</li>
              <li className="flex gap-2"><span className="text-orange-400 font-bold">4.</span> 10 turu tamamla ve kazanan sen ol!</li>
            </ul>
            <button
