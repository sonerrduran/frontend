...
const PASSAGES = [
    {
        ...
        questions: [
            { q: "Metne göre insanların gelecekte nerede yaşaması bekleniyor?", a: ["Sadece Mars'ta", "Sadece Ay'da", "Mars ve Ay'daki üslerde", "Güneş'te"], correct: 2 },
            { q: "Üslerin tasarımındaki temel özellik nedir?", a: ["Kendi kendine yetebilmeleri", "Çok büyük olmaları", "Sadece su üretmeleri", "Lüks olmaları"], correct: 0 }
        ]
    },
    {
        ...
        questions: [
            { q: "Robotlar artık nerede bulunuyor?", a: ["Sadece fabrikalarda", "Sadece laboratuvarlarda", "Evlerimizde ve her alanda", "Sadece uzayda"], correct: 2 },
            { q: "Robot teknolojisindeki en önemli gelişme nedir?", a: ["Hızlı hareket etmeleri", "Karmaşık problemleri çözebilmeleri", "Daha ucuz olmaları", "Renkli olmaları"], correct: 1 }
        ]
    }
];
            ...
            <div className="w-full max-w-2xl bg-slate-900/80 backdrop-blur-2xl rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl relative overflow-hidden text-center">
                ...
                {step === 'intro' && (
                    <div className="animate-in fade-in zoom-in duration-500">
                        ...
                        <p className="text-white/60 mb-10">Metni 15 saniye içinde okuyup anlamanız gerekiyor. Süre bitince sorular gelecek!</p>
                        <button
                ...
                {step === 'reading' && (
                    <div className="animate-in fade-in duration-300">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-sm font-black text-cyan-400 uppercase tracking-widest">{currentPassage.title}</h3>
                ...
                {step === 'quiz' && (
                    <div className="animate-in slide-in-from-right duration-300">
                        <p className="text-xs font-black opacity-40 mb-2 uppercase tracking-widest">Soru {quizIndex + 1} / {currentPassage.questions.length}</p>
