    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-2xl bg-slate-800/80 backdrop-blur-xl rounded-[40px] p-1 border border-slate-700 shadow-2xl">
                {/* İç Oyun Alanı */}
                <div className={`bg-gradient-to-br ${mode === 'work' ? 'from-rose-500 to-red-600' : 'from-cyan-500 to-blue-600'} rounded-[36px] p-8 relative overflow-hidden`}>
                    {/* Çıkış Butonu */}
                    <button
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[600px] text-white">
                        ...
                        <div className="w-full max-w-md space-y-6">
                            ...
                            <p className="text-center text-[10px] font-bold opacity-60">4 DÖNGÜ SONRASI UZUN MOLA</p>
                        </div>
                    </div>
                </div>
            </div>
