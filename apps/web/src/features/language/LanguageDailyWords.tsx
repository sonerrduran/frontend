...
const DAILY_WORDS = [
    { word: "ev", meaning: "İnsanların yaşadığı yapı", example: "Evimiz çok güzel.", category: "İsim" },
    { word: "okul", meaning: "Eğitim verilen yer", example: "Okula her gün gidiyorum.", category: "İsim" },
    { word: "yemek", meaning: "Beslenme için alınan gıda", example: "Yemek çok lezzetli.", category: "İsim" },
    { word: "gitmek", meaning: "Bir yerden başka bir yere hareket etmek", example: "Parka gitmek istiyorum.", category: "Fiil" },
    { word: "gelmek", meaning: "Bir yerden buraya doğru hareket etmek", example: "Yarın bize gelecek.", category: "Fiil" },
    { word: "konuşmak", meaning: "Söz söylemek, diyalog kurmak", example: "Seninle konuşmak istiyorum.", category: "Fiil" },
    { word: "görmek", meaning: "Gözle algılamak", example: "Seni görmek güzel.", category: "Fiil" },
    { word: "yapmak", meaning: "Bir işi gerçekleştirmek", example: "Ödevimi yapmam gerek.", category: "Fiil" },
    { word: "almak", meaning: "Bir şeyi edinmek", example: "Marketten ekmek aldım.", category: "Fiil" },
    { word: "vermek", meaning: "Bir şeyi başkasına teslim etmek", example: "Ona hediye verdim.", category: "Fiil" },
