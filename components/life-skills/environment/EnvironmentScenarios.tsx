  ...
  1: [
    {
      ...
      options: [
        { text: 'Yere atmalıyım', isCorrect: false, feedback: 'Çöpleri yere atmak çevreyi kirletir.' },
        { text: 'Çöp kutusuna kadar gitmeli ve oraya atmalıyım', isCorrect: true, feedback: 'Doğru! Çöpleri her zaman çöp kutusuna atmalıyız.' },
        { text: 'Ağacın altına bırakmalıyım', isCorrect: false, feedback: 'Bu da çevreyi kirletir.' }
      ]
    }
  ],
  2: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Musluğu açık bırakmalıyım', isCorrect: false, feedback: 'Su israfı çevreye zarar verir.' },
        { text: 'Dişlerimi fırçalarken musluğu kapatmalıyım', isCorrect: true, feedback: 'Doğru! Su tasarrufu yapmak çok önemli.' },
        { text: 'Hızlıca fırçalamalıyım', isCorrect: false, feedback: 'Musluğu kapatmak daha doğru.' }
      ]
    }
  ],
  3: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hepsini aynı çöp kutusuna atmalıyım', isCorrect: false, feedback: 'Geri dönüşüm için ayırmalıyız.' },
        { text: 'Plastik, cam ve kağıtları ayırarak geri dönüşüm kutularına atmalıyım', isCorrect: true, feedback: 'Doğru! Geri dönüşüm çevreyi korur.' },
  ...
  4: [
    {
      ...
      options: [
        ...
        { text: 'Geri dönüp ışıkları kapatmalıyım', isCorrect: true, feedback: 'Doğru! Enerji tasarrufu çevreyi korur.' },
        { text: 'Başkası kapatır', isCorrect: false, feedback: 'Herkes kendi sorumluluğunu almalı.' }
      ]
    }
  ],
  5: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Görmezden gelmeliyim', isCorrect: false, feedback: 'Hayvanlara yardım etmek önemli.' },
        { text: 'Su ve yemek vermeliyim, gerekirse yetişkinlerden yardım istemeliyim', isCorrect: true, feedback: 'Doğru! Hayvanlara şefkatle davranmalıyız.' },
  ...
  6: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Plastik poşet almalıyım', isCorrect: false, feedback: 'Plastik çevreye zarar verir.' },
        { text: 'Bez çanta kullanmalıyım', isCorrect: true, feedback: 'Doğru! Bez çanta çevre dostu bir seçim.' },
        { text: 'Çok poşet almalıyım', isCorrect: false, feedback: 'Plastik kullanımını azaltmalıyız.' }
      ]
    }
  ],
  7: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Ben de katılmamalıyım', isCorrect: false, feedback: 'Gönüllülük önemli bir sorumluluktur.' },
        { text: 'Gönüllü olmalı ve arkadaşlarımı da teşvik etmeliyim', isCorrect: true, feedback: 'Doğru! Topluma katkı sağlamak önemli.' },
  ...
  8: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Arabayla gitmeye devam etmeliyim', isCorrect: false, feedback: 'Karbon ayak izini artırır.' },
        { text: 'Yürüyerek veya bisikletle gitmeliyim', isCorrect: true, feedback: 'Doğru! Sürdürülebilir ulaşım çevreyi korur.' },
        { text: 'Her gün farklı arabayla gitmeliyim', isCorrect: false, feedback: 'Bu daha fazla kirlilik yaratır.' }
      ]
    }
  ]
};
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <div className="bg-cyan-500/20 px-4 py-2 rounded-full border border-cyan-500/30">
              <span className="text-cyan-300 font-bold">Tamamlanan: {completedScenarios.length}/{allScenarios.length}</span>
            </div>
          </div>
        </div>
