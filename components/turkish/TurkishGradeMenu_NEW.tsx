...
export default function TurkishGradeMenu() {
  ...
  // Debug log
  console.log('TurkishGradeMenu - Grade:', grade);
  console.log('TurkishGradeMenu - Data:', data);
  console.log('TurkishGradeMenu - Categories:', data?.categories);

  if (!data) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-gray-800">Sınıf bulunamadı</h1>
          <button
