                    ...
                    <div className="text-center max-w-lg">
                        <div className="text-6xl mb-6 flex justify-center">
                            <div className="bg-red-500/20 p-6 rounded-full w-24 h-24 flex items-center justify-center border-4 border-red-500/50 relative">
                                <span className="relative z-10 text-red-500 font-extrabold text-5xl italic drop-shadow-[0_0_15px_rgba(239,68,68,0.8)] animate-pulse">!</span>
                            </div>
                        </div>
                        <h2 className="text-2xl md:text-4xl font-black text-white italic drop-shadow-2xl mb-4 uppercase tracking-tighter break-words">Sistemsel Hata</h2>
