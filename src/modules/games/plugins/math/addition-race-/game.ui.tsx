...
export const AdditionRaceGame: React.FC<GameUIProps> = ({
  config,
  logic,
  onComplete,
  onExit,
        ...
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-3xl border border-slate-700 p-8">
          <div className="bg-gradient-to-br from-yellow-500 via-amber-500 to-yellow-600 rounded-2xl p-8 md:p-12 mb-8">
            <div className="text-center mb-6">
              <div className={`inline-block px-8 py-4 rounded-2xl font-black text-4xl ${
                timeLeft <= 3 ? 'bg-red-500/40 text-white animate-pulse border-2 border-red-300' : 'bg-yellow-700/40 text-white border-2 border-yellow-400'
              }`}>
                ⏱️ {timeLeft}s
              </div>
            </div>
