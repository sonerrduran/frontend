...
const BOARDS: Record<number, BoardData> = {
    4: {
        ...
        starsPerLine: 1,
        regions: [
            { id: 1, cells: [{ r: 0, c: 0 }, { r: 0, c: 1 }, { r: 1, c: 0 }] },
            { id: 2, cells: [{ r: 0, c: 2 }, { r: 0, c: 3 }, { r: 1, c: 3 }] },
            { id: 3, cells: [{ r: 1, c: 1 }, { r: 1, c: 2 }, { r: 2, c: 1 }, { r: 2, c: 2 }] },
            { id: 4, cells: [{ r: 2, c: 0 }, { r: 3, c: 0 }, { r: 3, c: 1 }] },
            { id: 5, cells: [{ r: 2, c: 3 }, { r: 3, c: 2 }, { r: 3, c: 3 }] }
    ...
    5: {
        ...
        starsPerLine: 1,
        regions: [
            { id: 1, cells: [{ r: 0, c: 0 }, { r: 0, c: 1 }, { r: 1, c: 0 }, { r: 2, c: 0 }] },
            { id: 2, cells: [{ r: 0, c: 2 }, { r: 0, c: 3 }, { r: 1, c: 2 }, { r: 1, c: 3 }] },
            { id: 3, cells: [{ r: 0, c: 4 }, { r: 1, c: 4 }, { r: 2, c: 4 }] },
            { id: 4, cells: [{ r: 1, c: 1 }, { r: 2, c: 1 }, { r: 2, c: 2 }, { r: 3, c: 1 }, { r: 3, c: 2 }] },
            { id: 5, cells: [{ r: 2, c: 3 }, { r: 3, c: 3 }, { r: 4, c: 3 }, { r: 4, c: 4 }] },
            { id: 6, cells: [{ r: 3, c: 4 }] },
            { id: 7, cells: [{ r: 3, c: 0 }, { r: 4, c: 0 }, { r: 4, c: 1 }, { r: 4, c: 2 }] }
        ] // same as Suguru 5x5 regions for simplicity
    },
    8: { // For Hard/Very Hard, a typical 8x8 2-star logic
        size: 8,
        starsPerLine: 2,
        regions: [
            { id: 1, cells: [{ r: 0, c: 0 }, { r: 0, c: 1 }, { r: 0, c: 2 }, { r: 1, c: 0 }] },
            { id: 2, cells: [{ r: 0, c: 3 }, { r: 0, c: 4 }, { r: 0, c: 5 }, { r: 0, c: 6 }, { r: 0, c: 7 }, { r: 1, c: 7 }] },
            { id: 3, cells: [{ r: 1, c: 1 }, { r: 1, c: 2 }, { r: 2, c: 0 }, { r: 2, c: 1 }, { r: 3, c: 0 }] },
            { id: 4, cells: [{ r: 1, c: 3 }, { r: 1, c: 4 }, { r: 2, c: 2 }, { r: 2, c: 3 }, { r: 3, c: 1 }, { r: 3, c: 2 }, { r: 4, c: 0 }, { r: 4, c: 1 }] },
            { id: 5, cells: [{ r: 1, c: 5 }, { r: 1, c: 6 }, { r: 2, c: 4 }, { r: 2, c: 5 }, { r: 2, c: 6 }, { r: 3, c: 3 }, { r: 3, c: 4 }] },
            { id: 6, cells: [{ r: 2, c: 7 }, { r: 3, c: 5 }, { r: 3, c: 6 }, { r: 3, c: 7 }, { r: 4, c: 5 }, { r: 4, c: 6 }, { r: 5, c: 5 }] },
            { id: 7, cells: [{ r: 4, c: 2 }, { r: 4, c: 3 }, { r: 4, c: 4 }, { r: 5, c: 3 }, { r: 5, c: 4 }, { r: 6, c: 4 }] },
            { id: 8, cells: [{ r: 5, c: 0 }, { r: 5, c: 1 }, { r: 6, c: 0 }, { r: 7, c: 0 }, { r: 7, c: 1 }] },
            { id: 9, cells: [{ r: 5, c: 2 }, { r: 6, c: 1 }, { r: 6, c: 2 }, { r: 6, c: 3 }, { r: 7, c: 2 }, { r: 7, c: 3 }] },
            { id: 10, cells: [{ r: 4, c: 7 }, { r: 5, c: 6 }, { r: 5, c: 7 }, { r: 6, c: 5 }, { r: 6, c: 6 }, { r: 6, c: 7 }, { r: 7, c: 4 }, { r: 7, c: 5 }, { r: 7, c: 6 }, { r: 7, c: 7 }] }
        ]
    }
};

const StarBattleGame: React.FC<StarBattleGameProps> = ({ grade, difficulty, onComplete, onExit }) => {
    const getSizeForDifficulty = () => {
        switch (difficulty) {
            case Difficulty.VERY_EASY: return 4;
            case Difficulty.EASY: return 5;
            default: return 8; // 8x8 uses 2 stars
        }
    };
        ...
        <>
            ...
            >
                        ...
                        {board.map((row, r) =>
                            row.map((cellState, c) => {
                                ...
                                return (
                                    ...
                                    >
                                        {cellState === 'star' ? '⭐' : cellState === 'cross' ? <span className="text-rose-500/70 text-2xl">❌</span> : ''}
                                    </button>
                                );
                            })
                        )}
                ...
                <div className="text-center bg-white/10 p-4 rounded-2xl">
                    <p className="text-white text-sm font-bold">1 Tık: <span className="mx-1">⭐</span> | 2 Tık: <span className="mx-1 text-rose-300">❌</span> | 3 Tık: Boş</p>
                </div>
            </LogicGameWrapper>
