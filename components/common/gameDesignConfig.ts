...
export const buttonStyles = {
  ...
  rules: 'px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-xl font-bold transition-all transform hover:scale-105',
  
  // Oyun içi ana butonlar
  primary: 'px-8 py-6 rounded-2xl font-black text-2xl transition-all transform hover:scale-105 shadow-lg',
  ...
  overlaySecondary: 'w-full bg-slate-700/50 hover:bg-slate-600/50 text-white font-bold py-4 rounded-xl transition-all transform hover:scale-105'
};
