...
const Whiteboard: React.FC<Props> = ({ onExit }) => {
    ...
    const colors = ['#ffffff', '#ef4444', '#f97316', '#eab308', '#22c55e', '#0ea5e9', '#6366f1', '#a855f7', '#ec4899', '#000000'];
    ...
    return (
        <div className="w-full h-screen max-w-7xl mx-auto flex flex-col p-2 pt-4 pb-6 md:p-6" ref={containerRef}>
            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl md:text-3xl font-black text-white flex items-center gap-3">
                        ...
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-emerald-400">Beyaz Tahta</span>
                    </h2>
                </div>
                ...
                <div className="flex items-center gap-2 bg-slate-800/80 backdrop-blur-md p-1.5 rounded-2xl border border-slate-700">
                    ...
                    <button onClick={clearCanvas} className="p-2 hover:bg-red-500/20 text-red-400 rounded-xl transition-all" title="Temizle">
                        🗑️
                    </button>
                    <button onClick={handleDownload} className="p-2 hover:bg-emerald-500/20 text-emerald-400 rounded-xl transition-all" title="İndir">
                        💾
                    </button>
                </div>
            </div>
