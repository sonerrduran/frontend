  ...
  1: [
    {
      ...
      options: [
        { text: 'Hepsini harcamalıyım', isCorrect: false, feedback: 'Para biriktirmek önemli bir alışkanlıktır.' },
        { text: 'Kumbara almalı ve biriktirmeye başlamalıyım', isCorrect: true, feedback: 'Doğru! Kumbara para biriktirmek için harika bir araçtır.' },
        { text: 'Yastık altına koymalıyım', isCorrect: false, feedback: 'Kumbara daha güvenli ve düzenli bir yöntemdir.' }
      ]
    }
  ],
  2: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'İstediğim her şeyi almalıyım', isCorrect: false, feedback: 'Para sınırlı olduğunda öncelik belirlemek önemli.' },
        { text: 'Önce ihtiyaçları almalı, sonra para kalırsa isteklerimi almalıyım', isCorrect: true, feedback: 'Doğru! Önce ihtiyaçlar, sonra istekler gelir.' },
        { text: 'Hiçbir şey almamalıyım', isCorrect: false, feedback: 'İhtiyaçları karşılamak gerekli.' }
      ]
    }
  ],
  3: [
    {
      ...
      icon: '🎮',
      scenario: 'Kumbarandaki para ile ya oyuncak ya da kitap alabilirsin. İkisini birden alamazsın.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen oyuncak almalıyım', isCorrect: false, feedback: 'Acele karar vermek yerine düşünmelisin.' },
        { text: 'Hangisine daha çok ihtiyacım var düşünmeli ve ona göre karar vermeliyim', isCorrect: true, feedback: 'Doğru! Bilinçli karar vermek önemli.' },
        { text: 'İkisini de almalıyım', isCorrect: false, feedback: 'Paran yetmiyor, seçim yapmalısın.' }
      ]
    }
  ],
  4: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Ben de her gün kantinden almalıyım', isCorrect: false, feedback: 'Her gün harcamak paranı hızla bitirir.' },
        { text: 'Harçlığımı planlayarak harcamalı, bir kısmını biriktirmeliyim', isCorrect: true, feedback: 'Doğru! Planlı harcamak ve biriktirmek önemli.' },
        { text: 'Hiç harcamamalıyım', isCorrect: false, feedback: 'Dengeli harcamak önemli, hiç harcamamak da doğru değil.' }
      ]
    }
  ],
  5: [
    {
      ...
      icon: '🏷️',
      scenario: 'İstediğin bisiklet %50 indirimde. Ama kumbarandaki para yetmiyor, biraz daha biriktirmen gerekiyor.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'İndirimi kaçırmamalıyım, ailemden borç almalıyım', isCorrect: false, feedback: 'Borç almak yerine sabırlı olmalısın.' },
        { text: 'Sabırla biriktirmeye devam etmeli, başka indirim fırsatlarını takip etmeliyim', isCorrect: true, feedback: 'Doğru! Sabır ve planlama önemli.' },
  ...
  6: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Kumbaramda tutmalıyım', isCorrect: false, feedback: 'Çok para olunca banka daha güvenli.' },
        { text: 'Banka hesabı açmalı, faiz kazanmalıyım', isCorrect: true, feedback: 'Doğru! Bankada para hem güvende hem de faiz kazanır.' },
        { text: 'Hepsini harcamalıyım', isCorrect: false, feedback: 'Biriktirdiğin parayı harcamak yerine değerlendirmelisin.' }
      ]
    }
  ],
  7: [
    {
      ...
      icon: '📈',
      scenario: 'Biriktirdiğin 1000₺ var. Ablan sana altın almayı öneriyor, arkadaşın ise hisse senedi.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen karar vermeliyim', isCorrect: false, feedback: 'Yatırım kararları acele verilmemeli.' },
        { text: 'Her iki seçeneği de araştırmalı, ailemle konuşmalı ve bilinçli karar vermeliyim', isCorrect: true, feedback: 'Doğru! Yatırım yapmadan önce araştırma ve danışma önemli.' },
        { text: 'Hepsini harcamalıyım', isCorrect: false, feedback: 'Biriktirdiğin parayı değerlendirmek daha akıllıca.' }
      ]
    }
  ],
  8: [
    {
      ...
      icon: '💳',
      scenario: '18 yaşına geldin. Banka sana kredi kartı teklif ediyor. Arkadaşların "Çok rahat, istediğini al" diyor.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen almalı ve istediğim her şeyi almalıyım', isCorrect: false, feedback: 'Kredi kartı borçtur, dikkatli kullanılmalı.' },
        { text: 'Kredi kartının avantaj ve dezavantajlarını öğrenmeli, gerçekten ihtiyacım varsa sorumlu kullanmalıyım', isCorrect: true, feedback: 'Doğru! Kredi kartı sorumlu kullanılmalı, borç tuzağına düşmemelisin.' },
        { text: 'Kesinlikle almamalıyım', isCorrect: false, feedback: 'Kredi kartı doğru kullanılırsa faydalı olabilir.' }
      ]
    }
  ]
};
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 p-4">
        <div className="w-full max-w-4xl mx-auto">
          <button onClick={handleBack} className="mb-6 px-6 py-2 bg-white/5 text-white rounded-full font-bold border border-white/20 hover:bg-white/10 transition-all text-sm">
            ⬅ Senaryolara Dön
          </button>
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <div className="bg-emerald-500/20 px-4 py-2 rounded-full border border-emerald-500/30">
              <span className="text-emerald-300 font-bold">Tamamlanan: {completedScenarios.length}/{allScenarios.length}</span>
            </div>
          </div>
        </div>
