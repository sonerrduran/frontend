    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-500 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <h3 className="text-3xl font-black text-purple-600 mb-8 text-center">Büyük Sayı Karşılaştır ⚖️</h3>
            ...
            {['<', '=', '>'].map((symbol) => (
              <button
                ...
                className={`p-8 rounded-2xl font-black text-6xl transition-all ${
                  showFeedback
                    ? symbol === correctAnswer ? 'bg-green-500 text-white scale-105' : symbol === selectedAnswer ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-400'
