...
export default function FakeNewsGame({ onExit }: FakeNewsGameProps) {
  ...
  const handleAnswer = (isFake: boolean) => {
    if (isFake === currentNews.isFake) {
      ...
      setFeedback(`❌ Yanlış! Bu haber ${currentNews.isFake ? 'sahte' : 'gerçek'}. Kaynağa dikkat et!`);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-white text-4xl md:text-5xl font-black mb-4">📰 Sahte Haber Dedektifi</h1>
