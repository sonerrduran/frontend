        ...
        if (gradeLevel <= 2) {
            return [
                {
                    ...
                    tips: [
                        'Ağaçlara zarar verme',
                        'Çiçekleri kopma',
                        'Hayvanlara iyi davran'
                    ]
                },
                {
                    id: 2,
            ...
            return [
                ...
                },
                {
                    ...
                    tips: [
                        'Hayvanlara saygı göster',
                        'Barınakları destekle',
                        'Sorumlu sahiplen'
                    ]
                },
                {
