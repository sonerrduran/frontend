...
const IDIOMS = [
    { idiom: "Kulağına küpe olmak", meaning: "Söyleneni iyi dinlemek ve unutmamak", example: "Söylediklerim kulağına küpe olsun!" },
    { idiom: "Gözden düşmek", meaning: "Değer kaybetmek, saygınlığını yitirmek", example: "Yaptığı hatadan sonra gözden düştü." },
    { idiom: "Etekleri zil çalmak", meaning: "Çok sevinmek", example: "Haberi duyunca etekleri zil çaldı." },
    { idiom: "Ağzı kulaklarına varmak", meaning: "Çok mutlu olmak", example: "Hediyeyi görünce ağzı kulaklarına vardı." },
    { idiom: "Burnundan kıl aldırmamak", meaning: "Çok kibirli olmak", example: "Burnundan kıl aldırmaz, çok gururlu." },
    ...
    { idiom: "Göz göre göre", meaning: "Bilerek, farkında olarak", example: "Göz göre göre hata yaptı." },
