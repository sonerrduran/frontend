...
export const authAPI = {
    register: (data: { email: string; password: string; name: string; role?: string; gradeLevel?: number; schoolCode?: string }) =>
...
export const questionAPI = {
    ...
    getNext: (data: { subjectId?: string; topicId?: string; difficulty?: string; gradeLevel?: number; count?: number }) =>
...
export const curriculumAPI = {
    ...
    topics: (subjectId: string, grade?: number) => api.get('/curriculum/topics', { params: { subjectId, grade } }),
...
export const classroomAPI = {
    ...
    addStudent: (id: string, studentEmail: string) => api.post(`/classrooms/${id}/students`, { studentEmail }),
    removeStudent: (id: string, studentId: string) => api.delete(`/classrooms/${id}/students/${studentId}`),
...
export const dutyAPI = {
    ...
    bulkAssignments: (id: string, assignments: any[]) => api.post(`/duty/${id}/assignments/bulk`, { assignments }),
    deleteAssignment: (id: string, assignmentId: string) => api.delete(`/duty/${id}/assignments/${assignmentId}`),
};
...
export const gameAPI = {
    ...
    games: async (params?: { categoryId?: string; gradeLevel?: number; difficulty?: string; featured?: boolean }) => {
        if (USE_MOCK) {
            await mockDelay();
            ...
            if (params?.gradeLevel) {
                filtered = filtered.filter(g => g.gradeMin <= params.gradeLevel! && g.gradeMax >= params.gradeLevel!);
            }
