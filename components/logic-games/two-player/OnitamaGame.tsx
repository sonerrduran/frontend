    ...
    const handleClick = (r: number, c: number) => {
        ...
        if (selected) {
            ...
            if (board[r][c] !== currentPlayer) {
                ...
                if ((currentPlayer === 1 && r === 0 && c === 2) || (currentPlayer === 2 && r === 4 && c === 2)) {
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-red-900 via-orange-900 to-amber-900 text-white p-4">
            <div className="w-full max-w-2xl bg-slate-900/90 backdrop-blur-xl rounded-[40px] p-6 md:p-8 border border-red-500/30 shadow-2xl">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-500">🥋 ONITAMA</h2>
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 text-center">
                    <p className="text-red-200 text-sm">🥋 Ustanızı karşı tapınağa götürün veya rakip ustayı yakalayın!</p>
                </div>
            </div>
        </div>
    );
