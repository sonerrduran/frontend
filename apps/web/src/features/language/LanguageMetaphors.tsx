...
const METAPHORS = [
    { phrase: "Taş kalpli", literal: "Taştan yapılmış kalp", metaphor: "Duygusuz, acımasız", example: "Çok taş kalpli biri, kimseye acımıyor." },
    { phrase: "Dil dökmek", literal: "Dili dökmek", metaphor: "Çok güzel konuşmak, iltifat etmek", example: "Ona dil döküyor ama samimi değil." },
    { phrase: "İçi yanmak", literal: "İçinin yanması", metaphor: "Çok üzülmek", example: "Onun durumuna içi yandı." },
    { phrase: "Gözü tok", literal: "Gözü doymuş", metaphor: "Kanaat eden, az şeyle yetinen", example: "Gözü tok bir insandır, fazlasını istemez." },
    { phrase: "Eli açık", literal: "Eli açık", metaphor: "Cömert", example: "Çok eli açık, herkese yardım eder." },
    { phrase: "Yüzü gülmek", literal: "Yüzünün gülmesi", metaphor: "Mutlu olmak", example: "Başarısıyla yüzü güldü." },
    { phrase: "Ağzı sıkı", literal: "Ağzı sıkı", metaphor: "Sır saklayan", example: "Ağzı sıkı biri, kimseye söylemez." },
    { phrase: "Kulağı kirişte", literal: "Kulağı kirişte", metaphor: "Dikkatli, uyanık", example: "Her zaman kulağı kirişte, her şeyi duyar." },
    { phrase: "Gözü yükseklerde", literal: "Gözü yüksekte", metaphor: "Hırslı, iddialı", example: "Gözü yükseklerde, büyük hedefleri var." },
    { phrase: "Eli ayağına dolaşmak", literal: "Eli ayağına dolaşmak", metaphor: "Telaşlanmak, şaşırmak", example: "Heyecandan eli ayağına dolaştı." }
];
