...
const SYNONYMS = [
    { word: "güzel", synonyms: ["hoş", "zarif", "şirin", "sevimli"], example: "Çok güzel bir manzara." },
                            ...
                            <div className="bg-white/5 p-6 rounded-2xl mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {current.synonyms.map((syn, i) => (
                                        <div key={i} className="bg-green-500/20 border-2 border-green-500 p-4 rounded-xl text-center font-bold text-xl">
                                            {syn}
                                        </div>
                                    ))}
                                </div>
