          ...
          <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-8 mb-8">
            <div className="flex flex-wrap justify-center gap-4">
              {coins.map((coin, index) => (
                <div key={index} className="bg-yellow-400 rounded-full w-20 h-20 flex items-center justify-center text-2xl font-black text-slate-800 border-4 border-yellow-600">
                  {coin}₺
                </div>
              ))}
            </div>
