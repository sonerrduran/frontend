  ...
  1: [
    {
      ...
      options: [
        { text: 'Hemen tıklamalıyım', isCorrect: false, feedback: 'Bilinmeyen linklere tıklamak tehlikelidir.' },
        { text: 'Yetişkine göstermeliyim', isCorrect: true, feedback: 'Doğru! Şüpheli durumlarda mutlaka yetişkine danış.' },
        { text: 'Arkadaşıma göstermeliyim', isCorrect: false, feedback: 'Yetişkin yardımı gerekli.' }
      ]
    }
  ],
  2: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Oyunu bitirmeliyim', isCorrect: false, feedback: 'Uzun ekran süresi sağlığa zararlıdır.' },
        { text: 'Ara vermeli ve dinlenmeliyim', isCorrect: true, feedback: 'Doğru! Gözlerini dinlendirmek önemli.' },
  ...
  3: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Şifremi vermeliyim', isCorrect: false, feedback: 'Şifreni kimseyle paylaşmamalısın.' },
        { text: 'Şifremi vermemeli, açıklama yapmalıyım', isCorrect: true, feedback: 'Doğru! Şifreler kişiseldir, en yakın arkadaşınla bile paylaşma.' },
        { text: 'Başka bir şifre uydurup vermeliyim', isCorrect: false, feedback: 'Dürüst olmalısın.' }
      ]
    }
  ],
  4: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Cevap vermeliyim', isCorrect: false, feedback: 'Bilinmeyen kişilerle konuşmak tehlikelidir.' },
        { text: 'Mesajı görmezden gelmeli ve yetişkine söylemeliyim', isCorrect: true, feedback: 'Doğru! Bilinmeyen kişilerden gelen mesajları yetişkine göster.' },
        { text: 'Arkadaşlarıma göstermeliyim', isCorrect: false, feedback: 'Önce yetişkine göstermelisin.' }
      ]
    }
  ],
  5: [
    {
      ...
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Karışmamalıyım', isCorrect: false, feedback: 'Sessiz kalmak zorbalığı destekler.' },
        { text: 'Arkadaşımı savunmalı ve yetişkine haber vermeliyim', isCorrect: true, feedback: 'Doğru! Siber zorbalığa karşı dur ve yardım iste.' },
        { text: 'Ben de dalga geçmeliyim', isCorrect: false, feedback: 'Bu zorbalığa katılmak olur.' }
      ]
    }
  ],
  6: [
    {
      ...
      icon: '📍',
      scenario: 'Tatildeyken çektiğin fotoğrafı sosyal medyada paylaşmak istiyorsun. Konum bilgisi de eklenmiş.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Konum bilgisiyle paylaşmalıyım', isCorrect: false, feedback: 'Konum paylaşmak güvenlik riski oluşturur.' },
        { text: 'Konum bilgisini kaldırıp sonra paylaşmalıyım', isCorrect: true, feedback: 'Doğru! Konum bilgini paylaşma, güvenliğin için önemli.' },
        { text: 'Hiç paylaşmamalıyım', isCorrect: false, feedback: 'Konum bilgisini kaldırırsan paylaşabilirsin.' }
      ]
    }
  ],
  7: [
    {
      title: 'Yanlış Bilgi',
      icon: '❌',
      scenario: 'Sosyal medyada çok şaşırtıcı bir haber gördün. Arkadaşların paylaşıyor ama kaynak belirsiz.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Hemen paylaşmalıyım', isCorrect: false, feedback: 'Doğruluğunu kontrol etmeden paylaşmak yanlış bilgi yayar.' },
        { text: 'Kaynağını araştırmalı, doğruluğunu kontrol etmeliyim', isCorrect: true, feedback: 'Doğru! Paylaşmadan önce bilginin doğruluğunu kontrol et.' },
        { text: 'Arkadaşlarım paylaşıyorsa doğrudur', isCorrect: false, feedback: 'Herkes yanlış bilgi paylaşabilir.' }
      ]
    }
  ],
  8: [
    {
      ...
      icon: '📱',
      scenario: 'Telefonunu sürekli kontrol ediyorsun, arkadaşlarınla birlikteyken bile. Gerçek hayattan koptuğunu hissediyorsun.',
      question: 'Ne yapmalısın?',
      options: [
        { text: 'Devam etmeliyim, sorun yok', isCorrect: false, feedback: 'Dijital bağımlılık ciddi bir sorundur.' },
        { text: 'Dijital detoks yapmalı, telefon kullanımımı sınırlamalıyım', isCorrect: true, feedback: 'Doğru! Dengeli bir dijital yaşam için ara ver ve gerçek hayata odaklan.' },
        { text: 'Daha fazla uygulama indirmeliyim', isCorrect: false, feedback: 'Bu sorunu daha kötü yapar.' }
      ]
    }
  ]
};
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <div className="bg-purple-500/20 px-4 py-2 rounded-full border border-purple-500/30">
              <span className="text-purple-300 font-bold">Tamamlanan: {completedScenarios.length}/{allScenarios.length}</span>
            </div>
          </div>
        </div>
