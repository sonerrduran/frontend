...
const MathGrade3Menu: React.FC = () => {
  ...
  const topics = [
    { id: 'multiplication', name: 'Çarpma', icon: '✖️', description: 'Çarpma işlemleri',
      games: [
    ...
    { id: 'division', name: 'Bölme', icon: '➗', description: 'Bölme işlemleri',
      games: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
          {topics.map((topic) => (
            <div key={topic.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
              <div className="flex items-center gap-4 mb-4">
                <div className="text-5xl">{topic.icon}</div>
                <div><h3 className="text-2xl font-bold text-white">{topic.name}</h3>
                <p className="text-white/70 text-sm">{topic.description}</p></div>
              </div>
        ...
        <div className="mt-8 text-center">
          <button onClick={() => navigate('/academic/math')}
