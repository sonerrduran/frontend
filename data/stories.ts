...
export const stories: Story[] = [
  {
    ...
    activity: 'Çocuklar evde ailesiyle bir şeyleri paylaşabilir. Örneğin: meyve, oyuncak veya kitap.',
    wordCount: 95,
  ...
  },
  {
    ...
    lesson: 'Düzenli uyku çocukların sağlıklı büyümesi için çok önemlidir. Erken uyuyan çocuklar daha dinç ve mutlu olur.',
    questions: [
    ...
    activity: 'Çocuklar için bir uyku saati tablosu yapın. Her erken yattıklarında bir yıldız koyun.',
    wordCount: 98,
  ...
  },
  {
    ...
    lesson: 'Doğayı korumak hepimizin görevidir. Ağaçlar bize temiz hava verir ve dünyamızı güzelleştirir.',
    questions: [
  ...
  },
  {
    ...
    lesson: 'Dürüst olmak önemlidir. Başkasının eşyasını bulmak onu sahibine vermek gerekir. Dürüstlük bizi mutlu eder.',
    questions: [
  ...
  },
  {
    ...
    lesson: 'Yardımlaşmak güzeldir. Başkalarına yardım ettiğimizde, onlar da bize yardım eder. Arkadaşlık karşılıklıdır.',
    questions: [
    ...
    activity: 'Bu hafta ailenize 3 kez yardım edin. Her yardımda bir kalp çizin. Yardım defteri yapın.',
    wordCount: 138,
