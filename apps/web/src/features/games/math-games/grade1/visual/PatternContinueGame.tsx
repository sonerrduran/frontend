      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 mb-6">
          <div className="flex justify-between items-center mb-2">
            <span className="text-white font-bold">Soru {currentIndex + 1}/{patterns.length}</span>
          </div>
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          ...
          <div className="bg-gradient-to-br from-yellow-100 to-orange-100 rounded-2xl p-8 mb-8 border-4 border-yellow-400">
            <div className="flex justify-center items-center gap-4 mb-4">
              {current.sequence.map((item, index) => (
                <div key={index} className="w-20 h-20 bg-white rounded-xl flex items-center justify-center text-5xl shadow-lg">
                  {item}
                </div>
              ))}
          ...
          {showFeedback && (
            <div className={`mt-6 p-4 rounded-2xl text-center font-bold text-xl ${
              selectedAnswer === current.answer ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
            }`}>
