...
const MoneyCountGame: React.FC<MoneyCountGameProps> = ({ onComplete, onExit }) => {
  ...
  const generateNewQuestion = () => {
    ...
    const allOptions = [total, ...wrongOptions.slice(0, 2)]
          ...
          <div className="bg-gradient-to-br from-yellow-100 to-amber-100 rounded-2xl p-8 mb-8 border-4 border-yellow-400">
            <div className="flex flex-wrap justify-center gap-4">
              {currentCoins.map((coin, index) => (
                <div key={index} className={`bg-gradient-to-br ${coin.color} rounded-full w-24 h-24 flex flex-col items-center justify-center text-white shadow-lg`}>
