...
type ShapeType = 'circle' | 'square' | 'triangle' | 'rectangle' | 'pentagon' | 'hexagon' | 'oval' | 'diamond';
...
const GeometricShapeRecognitionGame: React.FC<GeometricShapeRecognitionGameProps> = ({ onBack }) => {
            ...
            {currentQuestion && (
              <>
                ...
                <div className="bg-blue-700/40 rounded-2xl p-12 mb-8 border-2 border-blue-300 text-center">
                  ...
                  <p className="text-white/70 text-lg">{SHAPE_DATA[currentQuestion.shape].description}</p>
                </div>
        ...
        <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl flex flex-col items-center justify-center z-50 p-6 text-center">
          <div className="bg-slate-800/90 p-6 md:p-8 rounded-3xl border border-blue-500/30 max-w-md w-full">
            ...
            <ul className="text-white/90 text-left space-y-3 mb-8 text-sm md:text-base">
              <li className="flex gap-2"><span className="text-blue-400 font-bold">1.</span> Ekranda bir geometrik şekil göreceksin</li>
              <li className="flex gap-2"><span className="text-blue-400 font-bold">2.</span> Şeklin adını doğru seçeneği bularak söyle</li>
              <li className="flex gap-2"><span className="text-blue-400 font-bold">3.</span> Doğru cevap verirsen puan kazanırsın</li>
              <li className="flex gap-2"><span className="text-blue-400 font-bold">4.</span> 10 turu tamamla ve şekil uzmanı ol!</li>
            </ul>
            <button
