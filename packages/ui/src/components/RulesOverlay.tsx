 ...
 */
export const RulesOverlay: React.FC<RulesOverlayProps> = ({
    show,
    onClose,
    title,
    emoji,
    ...
    const getGradientClasses = () => {
        switch (accentColor) {
            case 'yellow': return 'from-yellow-600 to-amber-700';
            case 'blue': return 'from-blue-600 to-cyan-700';
            case 'green': return 'from-green-600 to-emerald-700';
            case 'red': return 'from-red-600 to-rose-700';
            case 'purple': return 'from-purple-600 to-indigo-700';
            case 'orange': return 'from-orange-600 to-amber-700';
            case 'pink': return 'from-pink-600 to-rose-700';
            case 'cyan': return 'from-cyan-600 to-teal-700';
            case 'teal': return 'from-teal-600 to-cyan-700';
            default: return 'from-yellow-600 to-amber-700';
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/95 backdrop-blur-xl flex flex-col items-center justify-center z-50 p-6 text-center">
            <div className={`bg-slate-800/90 p-6 md:p-8 rounded-3xl border ${getBorderColor()} max-w-md w-full`}>
