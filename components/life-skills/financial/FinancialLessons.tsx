        ...
        if (gradeLevel <= 4) {
            return [
                {
                    ...
                    tips: [
                        'Paraları tanımayı öğren',
                        'Paraları saymayı pratik et',
                        'Paranın değerini anla'
                    ]
                },
                {
                    id: 2,
                    ...
                    tips: [
                        'Harçlığını kumbara da biriktir',
                        'Gereksiz şeyler alma',
                        'Ailenle konuş'
                    ]
                },
                {
            ...
            return [
                ...
                },
                {
                    ...
                    tips: [
                        'Güvenli alışveriş yap',
                        'Şifreni sakla',
                        'Ailenle birlikte kullan'
                    ]
                }
            ];
        } else {
            return [
                ...
                },
                {
                    ...
                    tips: [
                        'Vergi bilincini geliştir',
                        'Sigortanın önemini anla',
                        'Sorumlu ol'
                    ]
                }
            ];
