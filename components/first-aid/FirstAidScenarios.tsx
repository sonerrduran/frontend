...
const SCENARIOS: Scenario[] = [
    {
        ...
        options: [
            { text: 'Yarayı temiz suyla yıka', correct: true, feedback: '✅ Doğru! İlk adım yarayı temizlemek.' },
            { text: 'Yarayı elle ovala', correct: false, feedback: '❌ Hayır! Bu enfeksiyona neden olabilir.' },
            { text: 'Hiçbir şey yapma', correct: false, feedback: '❌ Hayır! Yardım etmelisin.' },
            { text: 'Öğretmene haber ver', correct: true, feedback: '✅ Doğru! Büyüklere haber vermek önemli.' }
        ],
        difficulty: 1
    },
    {
        ...
        options: [
            ...
            { text: 'Başını öne eğ ve burnu sık', correct: true, feedback: '✅ Mükemmel! Doğru müdahale bu.' },
            { text: 'Soğuk su iç', correct: false, feedback: '❌ Bu yeterli değil.' },
            { text: 'Koşarak sağlık odasına git', correct: false, feedback: '❌ Koşmak kanamayı artırır.' }
        ],
        difficulty: 2
    },
    {
        ...
        options: [
            { text: 'Soğuk suya tut (10-15 dk)', correct: true, feedback: '✅ Harika! Soğuk su yanığı rahatlatır.' },
    ...
    },
    {
        ...
        question: 'İlk yapman gereken ne?',
        options: [
            { text: 'Ayağa kaldırmaya çalış', correct: false, feedback: '❌ Hayır! Bu tehlikeli olabilir.' },
            { text: 'Yere yatır, bacakları yükselt', correct: true, feedback: '✅ Doğru! Beyne kan akışını artırır.' },
    ...
    },
    {
        ...
        options: [
            ...
            { text: 'Ağzını aç ve parmakla çıkar', correct: false, feedback: '❌ Daha derine itebilirsin.' }
        ],
        difficulty: 4
    },
    {
        ...
        options: [
            ...
            { text: 'Dinlendir, soğuk uygula, yükselt', correct: true, feedback: '✅ Mükemmel! RICE protokolü.' },
            { text: 'Sıcak su ile masaj yap', correct: false, feedback: '❌ İlk 48 saat soğuk uygulanmalı.' },
    ...
    },
    {
        ...
        question: 'İlk yapman gereken ne?',
        options: [
            { text: 'Yaralıyı hemen taşı', correct: false, feedback: '❌ Boyun/sırt yaralanması olabilir.' },
            { text: '112 yi ara, olay yerini güvenli hale getir', correct: true, feedback: '✅ Harika! Önce güvenlik, sonra yardım.' },
    ...
    },
    {
        ...
        options: [
            { text: 'Bilinç kontrol → 112 ara → 30 kompresyon → 2 solunum', correct: true, feedback: '✅ Mükemmel! CPR protokolünü biliyorsun.' },
            { text: 'Solunum → Kompresyon → 112 ara', correct: false, feedback: '❌ Sıra yanlış.' },
            { text: 'Su ver → Tokatlayarak uyandır', correct: false, feedback: '❌ Bu kalp durmasında işe yaramaz.' },
            { text: 'Sadece 112 yi ara ve bekle', correct: false, feedback: '❌ CPR hayat kurtarır, hemen başla!' }
        ],
        difficulty: 7
    },
    {
        ...
        question: 'Ne yapmalısın?',
        options: [
            { text: 'Hemen kustur', correct: false, feedback: '❌ Bazı zehirlerde kusturma tehlikelidir.' },
            { text: '114 Zehir Danışma ara, ürünü göster', correct: true, feedback: '✅ Doğru! Uzman yönlendirmesi şart.' },
    ...
    },
    {
        ...
        options: [
            ...
            { text: 'Elektriği kes, izole edici kullan', correct: true, feedback: '✅ Mükemmel! Önce güvenlik.' },
                    ...
                    <div className="bg-slate-900/90 backdrop-blur-xl rounded-[40px] p-8 border border-red-500/30 shadow-2xl">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <div className="inline-block bg-red-500/20 px-4 py-2 rounded-full">
                                <span className="text-red-300 font-bold text-sm">Seviye {selectedScenario.difficulty}</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 p-6 rounded-2xl mb-6">
                            <h3 className="font-black text-2xl mb-4 text-yellow-400">❓ {selectedScenario.question}</h3>
                        </div>
                    ...
                    {availableScenarios.map((scenario) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-sm text-white/60 mb-3">{scenario.situation.substring(0, 60)}...</p>
