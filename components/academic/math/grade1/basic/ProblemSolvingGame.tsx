...
const ProblemSolvingGame: React.FC<Props> = ({ onComplete, onExit }) => {
  ...
  const problems = [
    { text: "Ali'nin 3 elmasi var. Ayşe ona 2 elma daha verdi. Ali'nin kaç elması oldu?", answer: 5 },
    { text: "Bahçede 7 kelebek var. 3 tanesi uçtu. Kaç kelebek kaldı?", answer: 4 },
    { text: "Sepette 4 portakal var. Anne 3 portakal daha aldı. Toplam kaç portakal var?", answer: 7 },
    { text: "Parkta 8 çocuk oynuyor. 2 çocuk eve gitti. Kaç çocuk kaldı?", answer: 6 },
    { text: "Ahmet'in 5 arabası var. Babası ona 4 araba daha aldı. Toplam kaç arabası var?", answer: 9 },
