...
const EXERCISES = [
    {
        ...
        original: "Teknolojik aletlerin hayatımıza girmesiyle birlikte iletişim hızımız artsa da, yüz yüze kurulan gerçek bağlar zayıflamaya başladı.",
        acceptedKeywords: ["teknoloji", "iletişim", "zayıf", "sosyal", "insan", "hızlı", "azalmak", "gerçek"],
    },
    {
        title: "Doğa ve Çevre",
        original: "Doğal kaynakların hızla tükenmesi, gelecek nesillerin yaşam kalitesini ciddi şekilde tehdit eden küresel bir kriz haline geldi.",
        ...
        <div className="flex flex-col items-center justify-center min-h-[500px] p-4 text-white">
            <div className="w-full max-w-4xl bg-slate-900/80 backdrop-blur-2xl rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl">
                <div className="text-center mb-10">
                    <h3 className="font-black tracking-widest text-xs uppercase mb-2 opacity-40">YENİDEN İFADE ETME EGZERSİZİ</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-4">
                        <div className="bg-white/5 p-8 rounded-[32px] border border-white/10 relative">
                            <label className="absolute -top-3 left-6 bg-slate-900 px-3 text-[10px] font-black tracking-widest uppercase text-cyan-400">Orijinal Metin</label>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="relative">
                            <label className="absolute -top-3 left-6 bg-slate-900 px-3 text-[10px] font-black tracking-widest uppercase text-yellow-400">Senin Özetin</label>
                            <textarea
                        ...
                        {score === null ? (
                            ...
                            <div className="bg-white/5 p-6 rounded-[32px] text-center animate-in zoom-in">
                                <p className="text-xs font-black opacity-40 uppercase tracking-widest mb-2">Anlam Koruma Oranı</p>
                ...
                <div className="mt-8 bg-white/5 p-6 rounded-2xl border border-white/5">
                    ...
                    <p className="text-sm text-white/60">Anlamı bozmadan sadece kelimeleri değiştirin veya cümleyi tersten kurmayı deneyin. Bu egzersiz beyin esnekliğinizi artırır.</p>
                </div>
            </div>
        </div>
    );
